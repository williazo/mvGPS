...
#'   \deqn{\mathbf{D}\mid\mathbf{C}\sim N_{n x 2}(\boldsymbol{\beta}\mathbf{C}), \mathbf{I}_{n}, \Omega}
...
#'  \deqn{\Sigma_{D}=\boldsymol{\beta}\Sigma_{C},\boldsymbol{\beta}^{T} + \Omega.}
